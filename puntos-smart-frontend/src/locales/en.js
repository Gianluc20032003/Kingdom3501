...
export default {
  ...
  dashboard: {
    ...
    subtitle: 'Select a module from the menu to start recording your activities',
  ...
  mobilization: {
    ...
    subtitle: 'Register your mobilization points - Minimum required: 1,000 points',
  ...
  kvk: {
    ...
    battleScoring: 'Scoring System: T4 Kill = 10 pts, T5 Kill = 20 pts | T4 Death = 5 pts, T5 Death = 10 pts',
    ...
    ownT4DeathsThisStage: 'Own T4 Deaths (Gained in this stage)',
    t5KillsThisStage: 'T5 Kills (Gained in this stage)',
    ownT5DeathsThisStage: 'Own T5 Deaths (Gained in this stage)',
    battlePhoto: 'Battle Photo',
    battlePhotoDesc: 'Capture of your battle progress',
    deathsPhoto: 'Deaths Photo (Hall of Heroes)',
    deathsPhotoDesc: 'Capture of your deaths in the Hall of Heroes',
    ...
    photosRequired: 'Kills and deaths photos are required for initial registration',
    validHonor: 'Honor must be a valid number greater than or equal to 0',
    honorPhotoRequired: 'Honor photo is required for initial registration',
  ...
  mge: {
    ...
    noActiveEventsDesc: 'The administrator must configure an MGE event before you can apply.',
    applicationRegistered: 'Application Registered',
    applicationRegisteredDesc: 'Your application for {{type}} has been successfully registered. You can update it anytime before the event.',
  ...
  aoo: {
    ...
    noScheduledEventsDesc: 'The administrator must configure an AOO event to be able to register',
    ...
    noEnrollmentsDesc: 'Users will be able to register when there is a configured AOO event',
    validTroopsAmount: 'Troops amount must be a valid number',
    commandersRequired: 'You must specify the available commanders',
    commandersPhotoRequired: 'Commanders photo is required for initial registration',
  ...
  validation: {
    ...
    invalidUserId: 'ID can only contain letters, numbers, hyphens and underscores',
