...
const KvkAdminPage = () => {
  ...
  const loadData = async () => {
    try {
      ...
      if (rankingResponse.success) {
        ...
        showAlert(rankingResponse.message || 'Error al cargar ranking', 'error');
      }
    } catch (error) {
  ...
  const loadUserDetails = async (userId, userName) => {
    try {
      ...
      showAlert('Error al cargar detalles del usuario: ' + error.message, 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute('download', `kvk_ranking_${new Date().toISOString().split('T')[0]}.csv`);
        ...
        <main className="p-6 space-y-6">
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <p className="text-gray-600">
              Gestiona etapas, revisa rankings y analiza el desempeño de usuarios
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  {selectedUser ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                          <div className="bg-white rounded-lg p-4 shadow-sm">
                            ...
                            <p className="text-xl font-bold text-purple-600">
                              +{formatNumber(selectedUser.puntuacion?.puntos_honor || 0)}
                            </p>
                            <p className="text-xs text-gray-400">
                              {formatNumber(selectedUser.puntuacion?.honor_cantidad || 0)} × 5
                            </p>
                          </div>
                          ...
                          <div className="bg-white rounded-lg p-4 shadow-sm">
                            ...
                            <p className="text-xl font-bold text-green-600">
                              +{formatNumber(selectedUser.puntuacion?.puntos_kill_t4 || 0)}
                            </p>
                            <p className="text-xs text-gray-400">
                              {formatNumber(selectedUser.puntuacion?.total_kill_t4_batallas || 0)} × 10
                            </p>
                          </div>
                          ...
                          <div className="bg-white rounded-lg p-4 shadow-sm">
                            ...
                            <p className="text-xl font-bold text-green-600">
                              +{formatNumber(selectedUser.puntuacion?.puntos_kill_t5 || 0)}
                            </p>
                            <p className="text-xs text-gray-400">
                              {formatNumber(selectedUser.puntuacion?.total_kill_t5_batallas || 0)} × 20
                            </p>
                          </div>
                          ...
                          <div className="bg-white rounded-lg p-4 shadow-sm">
                            ...
                            <p className="text-xl font-bold text-red-600">
                              {formatNumber(selectedUser.puntuacion?.puntos_muertes_t4 || 0)}
                            </p>
                            <p className="text-xs text-gray-400">
                              {formatNumber(selectedUser.puntuacion?.total_muertes_t4_batallas || 0)} × -5
                            </p>
                          </div>
                          ...
                          <div className="bg-white rounded-lg p-4 shadow-sm">
                            ...
                            <p className="text-xl font-bold text-red-600">
                              {formatNumber(selectedUser.puntuacion?.puntos_muertes_t5 || 0)}
                            </p>
                            <p className="text-xs text-gray-400">
                              {formatNumber(selectedUser.puntuacion?.total_muertes_t5_batallas || 0)} × -10
                            </p>
                          </div>
                          ...
                          <div className="bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-lg p-4 shadow-lg">
                            ...
                            <p className="text-2xl font-bold">
                              {formatNumber(selectedUser.puntuacion?.puntuacion_total || 0)}
                            </p>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              <p className="text-lg font-bold">{formatNumber(selectedUser.initial.kill_t4_iniciales)}</p>
                            </div>
                            <div>
                              <p className="text-sm text-gray-500">Kill T5 Iniciales</p>
                              <p className="text-lg font-bold">{formatNumber(selectedUser.initial.kill_t5_iniciales)}</p>
                            </div>
                            <div>
                              <p className="text-sm text-gray-500">Muertes Iniciales</p>
                              <p className="text-lg font-bold">{formatNumber(selectedUser.initial.muertes_propias_iniciales)}</p>
                            </div>
                          </div>
                          <div className="flex space-x-4 mt-3">
                            {selectedUser.initial.foto_inicial_url && (
                              <img
                                ...
                                onClick={() => openImageModal(`http://localhost:8000/uploads/${selectedUser.initial.foto_inicial_url}`)}
                              />
                            )}
                            {selectedUser.initial.foto_muertes_iniciales_url && (
                              <img
                                src={`http://localhost:8000/uploads/${selectedUser.initial.foto_muertes_iniciales_url}`}
                                alt="Muertes iniciales"
                                className="w-16 h-16 object-cover rounded cursor-pointer hover:opacity-80 transition-opacity"
                                onClick={() => openImageModal(`http://localhost:8000/uploads/${selectedUser.initial.foto_muertes_iniciales_url}`)}
                              />
                            )}
                          </div>
                        </div>
                      ...
                      {/* Honor */}
                      {selectedUser.honor && selectedUser.honor.honor_cantidad && (
                        <div className="bg-yellow-50 rounded-lg p-4">
                          <h4 className="font-semibold text-gray-800 mb-3">🏆 Honor</h4>
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-2xl font-bold text-yellow-600">
                                {formatNumber(selectedUser.honor.honor_cantidad)}
                              </p>
                              <p className="text-sm text-gray-500">
                                {selectedUser.honor.fecha_registro && formatDate(selectedUser.honor.fecha_registro)}
                              </p>
                            </div>
                            {selectedUser.honor.foto_honor_url && (
                              <img
                                ...
                                alt="Honor"
                                className="w-16 h-16 object-cover rounded cursor-pointer hover:opacity-80 transition-opacity"
                                onClick={() => openImageModal(`http://localhost:8000/uploads/${selectedUser.honor.foto_honor_url}`)}
                              />
                            )}
                          </div>
                        </div>
                      ...
                      <div className="bg-white rounded-lg p-4">
                        ...
                        {selectedUser.batallas && selectedUser.batallas.length > 0 ? (
                            ...
                            {selectedUser.batallas.map((batalla) => (
                              <div key={batalla.etapa_id} className="border rounded-lg p-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-sm">
                                  <div>
                                    <p className="text-gray-500">Kill Points</p>
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-green-600">+{formatNumber(batalla.kill_t4 * 10)} pts</p>
                                  </div>
                                  <div>
                                    <p className="text-gray-500">Kills T5</p>
                                    <p className="font-semibold">{formatNumber(batalla.kill_t5)}</p>
                                    <p className="text-xs text-green-600">+{formatNumber(batalla.kill_t5 * 20)} pts</p>
                                  </div>
                                  <div>
                                    <p className="text-gray-500">Muertes T4</p>
                                    <p className="font-semibold">{formatNumber(batalla.muertes_propias_t4)}</p>
                                    <p className="text-xs text-red-600">-{formatNumber(batalla.muertes_propias_t4 * 5)} pts</p>
                                  </div>
                                  <div>
                                    <p className="text-gray-500">Muertes T5</p>
                                    <p className="font-semibold">{formatNumber(batalla.muertes_propias_t5)}</p>
                                    <p className="text-xs text-red-600">-{formatNumber(batalla.muertes_propias_t5 * 10)} pts</p>
                                  </div>
                                </div>
                                ...
                                <div className="flex justify-between items-center mt-3">
                                  ...
                                  <div className="text-right">
                                    ...
                                    <p className="font-bold text-blue-600">
                                      {(() => {
                                        const total = (batalla.kill_t4 * 10) + (batalla.kill_t5 * 20) - (batalla.muertes_propias_t4 * 5) - (batalla.muertes_propias_t5 * 10);
                                        return total >= 0 ? '+' : '';
                                      })()}{formatNumber((batalla.kill_t4 * 10) + (batalla.kill_t5 * 20) - (batalla.muertes_propias_t4 * 5) - (batalla.muertes_propias_t5 * 10))}
                                    </p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <p className="text-gray-500 text-center py-4">No hay batallas registradas</p>
                        )}
                      </div>
                    </div>
                  ) : (
                      ...
                      {ranking.length === 0 ? (
                        ...
                        <>
                            ...
                            <table className="w-full table-auto bg-white rounded-lg shadow">
                              ...
                              <tbody>
                                {currentRanking.map((user, index) => {
                                  ...
                                  return (
                                    <tr key={user.usuario_id} className="border-t border-gray-200 hover:bg-gray-50">
                                      ...
                                      <td className="p-3">
                                        <div>
                                          <div className="font-semibold">{formatNumber(user.honor_cantidad || 0)}</div>
                                          <div className="text-xs text-purple-600">+{formatNumber(user.puntos_honor || 0)} pts</div>
                                        </div>
                                      </td>
                                      <td className="p-3">
                                        <div>
                                          <div className="font-semibold">{formatNumber(user.total_kill_t4_batallas || 0)}</div>
                                          <div className="text-xs text-green-600">+{formatNumber(user.puntos_kill_t4 || 0)} pts</div>
                                        </div>
                                      </td>
                                      <td className="p-3">
                                        <div>
                                          <div className="font-semibold">{formatNumber(user.total_muertes_t4_batallas || 0)}</div>
                                          <div className="text-xs text-red-600">{formatNumber(user.puntos_muertes_t4 || 0)} pts</div>
                                        </div>
                                      </td>
                                      <td className="p-3">
                                        <div>
                                          <div className="font-semibold">{formatNumber(user.total_muertes_t5_batallas || 0)}</div>
                                          <div className="text-xs text-red-600">{formatNumber(user.puntos_muertes_t5 || 0)} pts</div>
                                        </div>
                                      </td>
                                      <td className="p-3">
                                      ...
                                      <td className="p-3">
                                        <button
                                          onClick={() => loadUserDetails(user.usuario_id, user.nombre_usuario)}
                          ...
                          {totalPages > 1 && (
                            <div className="flex justify-between items-center">
                              <p className="text-gray-600">
                                Mostrando {indexOfFirstItem + 1} a {Math.min(indexOfLastItem, ranking.length)} de {ranking.length} usuarios
                              </p>
                              <div className="flex space-x-2">
                ...
                <div className="space-y-6">
                    ...
                    {etapas.length === 0 ? (
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full table-auto bg-white rounded-lg shadow">
                          ...
                          <tbody>
                            {etapas.map((etapa) => (
                              <tr key={etapa.id} className="border-t border-gray-200 hover:bg-gray-50">
                  ...
                  {etapas.length > 0 && (
                    <div className="bg-blue-50 rounded-lg p-6">
                      <h3 className="text-lg font-semibold text-gray-800 mb-4">📊 Estadísticas de Etapas</h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-white rounded-lg p-4 shadow-sm">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4">
                  ...
                  <p className="text-2xl font-bold text-green-600">
                    {formatNumber(ranking.reduce((sum, user) => sum + (user.total_kill_t4_batallas || 0), 0))}
                  </p>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4">
                  <p className="text-sm text-blue-700">Total Kills T5</p>
                  <p className="text-2xl font-bold text-blue-600">
                    {formatNumber(ranking.reduce((sum, user) => sum + (user.total_kill_t5_batallas || 0), 0))}
                  </p>
                </div>
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg p-4">
                  <p className="text-sm text-orange-700">Total Honor</p>
                  <p className="text-2xl font-bold text-orange-600">
                    {formatNumber(ranking.reduce((sum, user) => sum + (user.honor_cantidad || 0), 0))}
                  </p>
                </div>
              </div>
            </div>
